...
| Collection window | `2026-04-14T09:40:15.247284Z` |
...
```
published packets         : 1
workflow families visible : score
latest packet date        : 2026-04-14T09:40:15.247284Z
...
This collection currently exposes one published `score` packet, so that dated stage leaf is the primary interpretive surface. Figure-backed evidence is already present in 1 published packet(s), so readers can stay inside the packet lane before consulting machine artifacts. Run IDs remain lineage context for `can-r0b70`; the collection alias is the reader-facing packet identity.
...
flowchart LR
	...
	B[Score packet<br/>score_20260414T093711179367Z]
	A --> B
```
...
```
collection packet   : docs/reports/collections/can-r0b70/collection/20260414T094015247284Z.collection.md
latest stage packet : docs/reports/collections/can-r0b70/processing/score/20260414T094015247284Z.score.md
...
source run root     : local_untracked/analysis/runs/score/score_20260414T093711179367Z
```
...
first published packet     : 2026-04-14T09:40:15.247284Z
latest published packet    : 2026-04-14T09:40:15.247284Z
stage families visible     : score
...
latest run id   : score_20260414T093711179367Z
...
| --- | --- | --- | --- | --- |
| 2026-04-14T09:40:15.247284Z | score | `score_20260414T093711179367Z` | [20260414T094015247284Z.collection.md](20260414T094015247284Z.collection.md) | [20260414T094015247284Z.score.md](../processing/score/20260414T094015247284Z.score.md) |
