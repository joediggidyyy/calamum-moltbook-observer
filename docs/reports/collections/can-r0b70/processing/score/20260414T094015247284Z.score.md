# Scoring packet — score_20260414T093711179367Z

**Decision**: `go`
**Workflow**: `score`
**Created (UTC)**: `2026-04-14T09:40:15.247284Z`
...
| --- | --- |
| Collection Alias | can-r0b70 |
| Calculation Run | score_20260414T093711179367Z |
| Model Lineage | train_20260414T092329710037Z |
...
```mermaid
flowchart LR
	A[Build dataset<br/>build-lineage] --> B[Trained model<br/>train_20260414T092329710037Z]
	B --> C[Score run<br/>score_20260414T093711179367Z]
...
model reference : local_untracked/analysis/runs/train/train_20260414T092329710037Z/model/model.pkl
score surface   : local_untracked/analysis/runs/score/score_20260414T093711179367Z/scoring/scores.csv
```
...
![Score distribution](figures/20260414T094015247284Z.score/score_distribution.png)
...
- [Scores CSV](../../../../../../local_untracked/analysis/runs/score/score_20260414T093711179367Z/scoring/scores.csv)
- [Resolved Model Path](../../../../../../local_untracked/analysis/runs/train/train_20260414T092329710037Z/model/model.pkl)
- [Score Distribution PNG](figures/20260414T094015247284Z.score/score_distribution.png)
