# Dataset Build packet — build_20260414T092257956667Z

**Decision**: `go`
**Workflow**: `build`
**Created (UTC)**: `2026-04-14T09:22:58.635893Z`
...
| --- | --- |
| Collection Alias | can-r0b70 |
| Calculation Run | build_20260414T092257956667Z |
...
```mermaid
flowchart LR
	A[Collection packet<br/>can-r0b70] --> B[Build run<br/>build_20260414T092257956667Z]
...
run-local dataset : local_untracked/analysis/runs/build/build_20260414T092257956667Z/dataset/dataset_manifest.json
feature table     : local_untracked/analysis/runs/build/build_20260414T092257956667Z/dataset/features.csv
```
...
```
labels present  : no
split authority : local_untracked/analysis/runs/build/build_20260414T092257956667Z/dataset/split_manifest.json
```
...
![Split balance](figures/20260414T092258635893Z.build/split_balance.png)

### Input slice volume

Relative contribution of each input slice that fed the dataset build.

![Input slice volume](figures/20260414T092258635893Z.build/input_slice_volume.png)

### Feature family breakdown

How the dataset schema is distributed across feature families used during downstream analysis.

![Feature family breakdown](figures/20260414T092258635893Z.build/feature_family_breakdown.png)
...
- [Dataset Manifest](../../../../../../local_untracked/analysis/runs/build/build_20260414T092257956667Z/dataset/dataset_manifest.json)
- [Features CSV](../../../../../../local_untracked/analysis/runs/build/build_20260414T092257956667Z/dataset/features.csv)
- [Feature Family Breakdown PNG](figures/20260414T092258635893Z.build/feature_family_breakdown.png)
- [Input Slice Volume PNG](figures/20260414T092258635893Z.build/input_slice_volume.png)
- [Split Balance PNG](figures/20260414T092258635893Z.build/split_balance.png)
- [Split Manifest JSON](../../../../../../local_untracked/analysis/runs/build/build_20260414T092257956667Z/dataset/split_manifest.json)
