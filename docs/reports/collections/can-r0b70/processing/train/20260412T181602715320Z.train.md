# Model Training packet — train_20260412T181433425502Z

**Decision**: `go`
**Workflow**: `train`
**Created (UTC)**: `2026-04-12T18:16:02.715320Z`
...
| --- | --- |
| Collection Alias | can-r0b70 |
| Calculation Run | train_20260412T181433425502Z |
...
```mermaid
flowchart LR
	A[Dataset bundle<br/>build-lineage] --> B[Training run<br/>train_20260412T181433425502Z]
...
model bundle    : local_untracked/analysis/runs/train/train_20260412T181433425502Z/model/model.pkl
train manifest  : local_untracked/analysis/runs/train/train_20260412T181433425502Z/model/train_manifest.json
```
...
- [Model Path](../../../../../../local_untracked/analysis/runs/train/train_20260412T181433425502Z/model/model.pkl)
- [Metrics Path](../../../../../../local_untracked/analysis/runs/train/train_20260412T181433425502Z/model/metrics.json)
- [Train Manifest](../../../../../../local_untracked/analysis/runs/train/train_20260412T181433425502Z/model/train_manifest.json)
