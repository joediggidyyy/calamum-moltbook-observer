# Model Training packet — train_20260414T092329710037Z

**Decision**: `go`
**Workflow**: `train`
**Created (UTC)**: `2026-04-14T09:25:20.875848Z`
...
| --- | --- |
| Collection Alias | can-r0b70 |
| Calculation Run | train_20260414T092329710037Z |
...
```mermaid
flowchart LR
	A[Dataset bundle<br/>build-lineage] --> B[Training run<br/>train_20260414T092329710037Z]
...
model bundle    : local_untracked/analysis/runs/train/train_20260414T092329710037Z/model/model.pkl
train manifest  : local_untracked/analysis/runs/train/train_20260414T092329710037Z/model/train_manifest.json
```
...
- [Model Path](../../../../../../local_untracked/analysis/runs/train/train_20260414T092329710037Z/model/model.pkl)
- [Metrics Path](../../../../../../local_untracked/analysis/runs/train/train_20260414T092329710037Z/model/metrics.json)
- [Train Manifest](../../../../../../local_untracked/analysis/runs/train/train_20260414T092329710037Z/model/train_manifest.json)
