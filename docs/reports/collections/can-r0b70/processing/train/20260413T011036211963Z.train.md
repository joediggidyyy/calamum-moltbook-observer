# Model Training packet — train_20260413T010829031589Z

**Decision**: `go`
**Workflow**: `train`
**Created (UTC)**: `2026-04-13T01:10:36.211963Z`
...
| --- | --- |
| Collection Alias | can-r0b70 |
| Calculation Run | train_20260413T010829031589Z |
...
```mermaid
flowchart LR
	A[Dataset bundle<br/>build-lineage] --> B[Training run<br/>train_20260413T010829031589Z]
...
model bundle    : local_untracked/analysis/runs/train/train_20260413T010829031589Z/model/model.pkl
train manifest  : local_untracked/analysis/runs/train/train_20260413T010829031589Z/model/train_manifest.json
```
...
- [Model Path](../../../../../../local_untracked/analysis/runs/train/train_20260413T010829031589Z/model/model.pkl)
- [Metrics Path](../../../../../../local_untracked/analysis/runs/train/train_20260413T010829031589Z/model/metrics.json)
- [Train Manifest](../../../../../../local_untracked/analysis/runs/train/train_20260413T010829031589Z/model/train_manifest.json)
