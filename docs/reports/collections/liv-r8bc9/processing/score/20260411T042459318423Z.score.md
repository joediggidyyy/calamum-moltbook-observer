# Scoring packet — score_20260411T042449359583Z

**Decision**: `go`
**Workflow**: `score`
**Created (UTC)**: `2026-04-11T04:24:59.318423Z`
...
| --- | --- |
| Collection Alias | liv-r8bc9 |
| Calculation Run | score_20260411T042449359583Z |
...
flowchart LR
	...
	B --> C[Score run<br/>score_20260411T042449359583Z]
...
model reference : local_untracked/analysis/runs/train/d3_alias_fix_train/model/model.pkl
score surface   : local_untracked/analysis/runs/score/d3_alias_fix_score/scoring/scores.csv
```
...
![Score distribution](figures/20260411T042459318423Z.score/score_distribution.png)
...
- [Scores CSV](../../../../../../local_untracked/analysis/runs/score/d3_alias_fix_score/scoring/scores.csv)
- [Resolved Model Path](../../../../../../local_untracked/analysis/runs/train/d3_alias_fix_train/model/model.pkl)
- [Score Distribution PNG](figures/20260411T042459318423Z.score/score_distribution.png)
