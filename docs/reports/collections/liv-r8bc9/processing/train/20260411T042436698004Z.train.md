# Model Training packet — train_20260411T042431425146Z

**Decision**: `go`
**Workflow**: `train`
**Created (UTC)**: `2026-04-11T04:24:36.698004Z`
...
| --- | --- |
| Collection Alias | liv-r8bc9 |
| Calculation Run | train_20260411T042431425146Z |
...
```mermaid
flowchart LR
	A[Dataset bundle<br/>build-lineage] --> B[Training run<br/>train_20260411T042431425146Z]
...
model bundle    : local_untracked/analysis/runs/train/d3_alias_fix_train/model/model.pkl
train manifest  : local_untracked/analysis/runs/train/d3_alias_fix_train/model/train_manifest.json
```
...
- [Model Path](../../../../../../local_untracked/analysis/runs/train/d3_alias_fix_train/model/model.pkl)
- [Metrics Path](../../../../../../local_untracked/analysis/runs/train/d3_alias_fix_train/model/metrics.json)
- [Train Manifest](../../../../../../local_untracked/analysis/runs/train/d3_alias_fix_train/model/train_manifest.json)
