# Dataset Build packet — build_20260411T042407214529Z

**Decision**: `go`
**Workflow**: `build`
**Created (UTC)**: `2026-04-11T04:24:09.067088Z`
...
| --- | --- |
| Collection Alias | liv-r8bc9 |
| Calculation Run | build_20260411T042407214529Z |
...
```mermaid
flowchart LR
	A[Collection packet<br/>liv-r8bc9] --> B[Build run<br/>build_20260411T042407214529Z]
...
run-local dataset : local_untracked/analysis/runs/build/d3_alias_fix_build/dataset/dataset_manifest.json
feature table     : local_untracked/analysis/runs/build/d3_alias_fix_build/dataset/features.csv
```
...
```
labels present  : no
split authority : local_untracked/analysis/runs/build/d3_alias_fix_build/dataset/split_manifest.json
```
...
![Split balance](figures/20260411T042409067088Z.build/split_balance.png)

### Input slice volume

Relative contribution of each input slice that fed the dataset build.

![Input slice volume](figures/20260411T042409067088Z.build/input_slice_volume.png)

### Feature family breakdown

How the dataset schema is distributed across feature families used during downstream analysis.

![Feature family breakdown](figures/20260411T042409067088Z.build/feature_family_breakdown.png)
...
- [Dataset Manifest](../../../../../../local_untracked/analysis/runs/build/d3_alias_fix_build/dataset/dataset_manifest.json)
- [Features CSV](../../../../../../local_untracked/analysis/runs/build/d3_alias_fix_build/dataset/features.csv)
- [Feature Family Breakdown PNG](figures/20260411T042409067088Z.build/feature_family_breakdown.png)
- [Input Slice Volume PNG](figures/20260411T042409067088Z.build/input_slice_volume.png)
- [Split Balance PNG](figures/20260411T042409067088Z.build/split_balance.png)
- [Split Manifest JSON](../../../../../../local_untracked/analysis/runs/build/d3_alias_fix_build/dataset/split_manifest.json)
