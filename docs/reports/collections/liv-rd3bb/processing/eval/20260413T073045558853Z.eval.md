# Evaluation packet — evaluate_20260413T073044783730Z

**Decision**: `go`
**Workflow**: `evaluate`
**Created (UTC)**: `2026-04-13T07:30:45.558853Z`
...
| --- | --- |
| Collection Alias | liv-rd3bb |
| Calculation Run | evaluate_20260413T073044783730Z |
...
flowchart LR
	...
	B --> C[Evaluation run<br/>evaluate_20260413T073044783730Z]
...
evaluation ledger : local_untracked/analysis/runs/evaluate/evaluate_20260413T073044783730Z/evaluation/run.json
```
...
![Metric comparison](figures/20260413T073045558853Z.eval/metric_comparison.png)

### Threshold summary

Threshold and FPR summary derived from the evaluation or threshold payload.

![Threshold summary](figures/20260413T073045558853Z.eval/threshold_summary.png)
...
- [Metric Comparison PNG](figures/20260413T073045558853Z.eval/metric_comparison.png)
- [Run JSON](../../../../../../local_untracked/analysis/runs/evaluate/evaluate_20260413T073044783730Z/evaluation/run.json)
- [Run MD](../../../../../../local_untracked/analysis/runs/evaluate/evaluate_20260413T073044783730Z/evaluation/run.md)
- [Threshold Summary PNG](figures/20260413T073045558853Z.eval/threshold_summary.png)
