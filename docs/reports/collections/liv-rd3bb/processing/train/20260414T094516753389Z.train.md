# Model Training packet — train_20260414T094501184301Z

**Decision**: `go`
**Workflow**: `train`
**Created (UTC)**: `2026-04-14T09:45:16.753389Z`
...
| --- | --- |
| Collection Alias | liv-rd3bb |
| Calculation Run | train_20260414T094501184301Z |
...
```mermaid
flowchart LR
	A[Dataset bundle<br/>build-lineage] --> B[Training run<br/>train_20260414T094501184301Z]
...
model bundle    : local_untracked/analysis/runs/train/train_20260414T094501184301Z/model/model.pkl
train manifest  : local_untracked/analysis/runs/train/train_20260414T094501184301Z/model/train_manifest.json
```
...
- [Model Path](../../../../../../local_untracked/analysis/runs/train/train_20260414T094501184301Z/model/model.pkl)
- [Metrics Path](../../../../../../local_untracked/analysis/runs/train/train_20260414T094501184301Z/model/metrics.json)
- [Train Manifest](../../../../../../local_untracked/analysis/runs/train/train_20260414T094501184301Z/model/train_manifest.json)
