# Model Training packet — train_20260413T073259573965Z

**Decision**: `go`
**Workflow**: `train`
**Created (UTC)**: `2026-04-13T07:33:00.032775Z`
...
| --- | --- |
| Collection Alias | liv-rd3bb |
| Calculation Run | train_20260413T073259573965Z |
...
```mermaid
flowchart LR
	A[Dataset bundle<br/>build-lineage] --> B[Training run<br/>train_20260413T073259573965Z]
...
model bundle    : local_untracked/analysis/runs/train/train_20260413T073259573965Z/model/model.pkl
train manifest  : local_untracked/analysis/runs/train/train_20260413T073259573965Z/model/train_manifest.json
```
...
- [Model Path](../../../../../../local_untracked/analysis/runs/train/train_20260413T073259573965Z/model/model.pkl)
- [Metrics Path](../../../../../../local_untracked/analysis/runs/train/train_20260413T073259573965Z/model/metrics.json)
- [Train Manifest](../../../../../../local_untracked/analysis/runs/train/train_20260413T073259573965Z/model/train_manifest.json)
