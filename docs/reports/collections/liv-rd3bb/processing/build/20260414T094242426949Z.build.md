# Dataset Build packet — build_20260414T094242225492Z

**Decision**: `go`
**Workflow**: `build`
**Created (UTC)**: `2026-04-14T09:42:42.426949Z`
...
| --- | --- |
| Collection Alias | liv-rd3bb |
| Calculation Run | build_20260414T094242225492Z |
...
```mermaid
flowchart LR
	A[Collection packet<br/>liv-rd3bb] --> B[Build run<br/>build_20260414T094242225492Z]
...
run-local dataset : local_untracked/analysis/runs/build/build_20260414T094242225492Z/dataset/dataset_manifest.json
feature table     : local_untracked/analysis/runs/build/build_20260414T094242225492Z/dataset/features.csv
labels table      : local_untracked/analysis/runs/build/build_20260414T094242225492Z/dataset/labels.csv
```
...
```
labels present  : yes
split authority : local_untracked/analysis/runs/build/build_20260414T094242225492Z/dataset/split_manifest.json
```
...
![Split balance](figures/20260414T094242426949Z.build/split_balance.png)

### Input slice volume

Relative contribution of each input slice that fed the dataset build.

![Input slice volume](figures/20260414T094242426949Z.build/input_slice_volume.png)

### Feature family breakdown

How the dataset schema is distributed across feature families used during downstream analysis.

![Feature family breakdown](figures/20260414T094242426949Z.build/feature_family_breakdown.png)
...
- [Dataset Manifest](../../../../../../local_untracked/analysis/runs/build/build_20260414T094242225492Z/dataset/dataset_manifest.json)
- [Features CSV](../../../../../../local_untracked/analysis/runs/build/build_20260414T094242225492Z/dataset/features.csv)
- [Labels CSV](../../../../../../local_untracked/analysis/runs/build/build_20260414T094242225492Z/dataset/labels.csv)
- [Feature Family Breakdown PNG](figures/20260414T094242426949Z.build/feature_family_breakdown.png)
- [Input Slice Volume PNG](figures/20260414T094242426949Z.build/input_slice_volume.png)
- [Split Balance PNG](figures/20260414T094242426949Z.build/split_balance.png)
