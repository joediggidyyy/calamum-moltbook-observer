# Dataset Build packet — build_20260413T024620291292Z

**Decision**: `go`
**Workflow**: `build`
**Created (UTC)**: `2026-04-13T02:46:20.493383Z`
...
| --- | --- |
| Collection Alias | liv-rd3bb |
| Calculation Run | build_20260413T024620291292Z |
...
```mermaid
flowchart LR
	A[Collection packet<br/>liv-rd3bb] --> B[Build run<br/>build_20260413T024620291292Z]
...
run-local dataset : local_untracked/analysis/runs/build/build_20260413T024620291292Z/dataset/dataset_manifest.json
feature table     : local_untracked/analysis/runs/build/build_20260413T024620291292Z/dataset/features.csv
labels table      : local_untracked/analysis/runs/build/build_20260413T024620291292Z/dataset/labels.csv
```
...
```
labels present  : yes
split authority : local_untracked/analysis/runs/build/build_20260413T024620291292Z/dataset/split_manifest.json
```

This stage should be read as dataset materialization rather than model judgment. The main reader value is custody and reproducibility: the dataset contract is explicit, reusable, and ready for the next stage in the reporting spine.
...
![Split balance](figures/20260413T024620493383Z.build/split_balance.png)

### Input slice volume

Relative contribution of each input slice that fed the dataset build.

![Input slice volume](figures/20260413T024620493383Z.build/input_slice_volume.png)

### Feature family breakdown

How the dataset schema is distributed across feature families used during downstream analysis.

![Feature family breakdown](figures/20260413T024620493383Z.build/feature_family_breakdown.png)
...
- [Dataset Manifest](../../../../../../local_untracked/analysis/runs/build/build_20260413T024620291292Z/dataset/dataset_manifest.json)
- [Features CSV](../../../../../../local_untracked/analysis/runs/build/build_20260413T024620291292Z/dataset/features.csv)
- [Labels CSV](../../../../../../local_untracked/analysis/runs/build/build_20260413T024620291292Z/dataset/labels.csv)
- [Feature Family Breakdown PNG](figures/20260413T024620493383Z.build/feature_family_breakdown.png)
- [Input Slice Volume PNG](figures/20260413T024620493383Z.build/input_slice_volume.png)
- [Split Balance PNG](figures/20260413T024620493383Z.build/split_balance.png)
