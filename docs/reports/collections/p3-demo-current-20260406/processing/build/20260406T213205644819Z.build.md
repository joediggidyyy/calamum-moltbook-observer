# Dataset Build packet — build_20260406T213204617082Z

**Decision**: `go`
**Workflow**: `build`
**Created (UTC)**: `2026-04-06T21:32:05.644819Z`
...
| --- | --- |
| Collection Alias | p3-demo-current-20260406 |
| Calculation Run | build_20260406T213204617082Z |
...
```mermaid
flowchart LR
	A[Collection packet<br/>p3-demo-current-20260406] --> B[Build run<br/>build_20260406T213204617082Z]
...
run-local dataset : local_untracked/analysis/runs/build/build_20260406T213204617082Z/dataset/dataset_manifest.json
feature table     : local_untracked/analysis/runs/build/build_20260406T213204617082Z/dataset/features.csv
```
...
```
labels present  : no
split authority : local_untracked/analysis/runs/build/build_20260406T213204617082Z/dataset/split_manifest.json
```
...
![Split balance](figures/20260406T213205644819Z.build/split_balance.png)

### Input slice volume

Relative contribution of each input slice that fed the dataset build.

![Input slice volume](figures/20260406T213205644819Z.build/input_slice_volume.png)

### Feature family breakdown

How the dataset schema is distributed across feature families used during downstream analysis.

![Feature family breakdown](figures/20260406T213205644819Z.build/feature_family_breakdown.png)
...
- [Dataset Manifest](../../../../../../local_untracked/analysis/runs/build/build_20260406T213204617082Z/dataset/dataset_manifest.json)
- [Features CSV](../../../../../../local_untracked/analysis/runs/build/build_20260406T213204617082Z/dataset/features.csv)
- [Feature Family Breakdown PNG](figures/20260406T213205644819Z.build/feature_family_breakdown.png)
- [Input Slice Volume PNG](figures/20260406T213205644819Z.build/input_slice_volume.png)
- [Split Balance PNG](figures/20260406T213205644819Z.build/split_balance.png)
- [Split Manifest JSON](../../../../../../local_untracked/analysis/runs/build/build_20260406T213204617082Z/dataset/split_manifest.json)
