...
| --- | --- |
| Collection Alias | p3-demo-current-20260406 |
| Calculation Run | score_20260406T170017731886Z |
| Model Lineage | train_20260406T165940271708Z |
...
```mermaid
flowchart LR
	A[Build dataset<br/>build-lineage] --> B[Trained model<br/>train_20260406T165940271708Z]
	B --> C[Score run<br/>score_20260406T170017731886Z]
...
model reference : local_untracked/analysis/runs/train/train_20260406T165940271708Z/model/model.pkl
score surface   : local_untracked/analysis/runs/score/score_20260406T170017731886Z/scoring/scores.csv
```
