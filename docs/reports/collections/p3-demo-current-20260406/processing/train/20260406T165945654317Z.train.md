...
| --- | --- |
| Collection Alias | p3-demo-current-20260406 |
| Calculation Run | train_20260406T165940271708Z |
...
```mermaid
flowchart LR
	A[Dataset bundle<br/>build-lineage] --> B[Training run<br/>train_20260406T165940271708Z]
...
model bundle    : local_untracked/analysis/runs/train/train_20260406T165940271708Z/model/model.pkl
