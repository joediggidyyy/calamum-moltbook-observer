...
| the safest runtime path through the system | [`runtime/CALAMUM_RUNTIME_WORKFLOWS.md`](runtime/CALAMUM_RUNTIME_WORKFLOWS.md) -> [`runtime/CALAMUM_RUNTIME_OPERATIONS.md`](runtime/CALAMUM_RUNTIME_OPERATIONS.md) |
| posture, denial behavior, and security boundaries | [`reference/CALAMUM_SECURITY_MODEL.md`](reference/CALAMUM_SECURITY_MODEL.md) -> [`reference/CALAMUM_RUNTIME_TRANSITIONS.md`](reference/CALAMUM_RUNTIME_TRANSITIONS.md) |
| the analysis and reporting lane | [`data-science/CALAMUM_DS_OPERATIONS.md`](data-science/CALAMUM_DS_OPERATIONS.md) -> [`data-science/CALAMUM_DS_WIZARD.md`](data-science/CALAMUM_DS_WIZARD.md) -> [`../reports/ds/INDEX.md`](../reports/ds/INDEX.md) |
