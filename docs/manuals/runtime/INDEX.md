...
This section covers day-to-day runtime use of the Calamum observer stack.

## What lives here

| Document | Purpose | Read it when you need... |
| --- | --- | --- |
| [`RUNTIME_WORKFLOWS.md`](RUNTIME_WORKFLOWS.md) | End-to-end operating path from readiness through closure and analysis handoff | the safest order of operations for baseline, runtime, and closeout work |
